# FILE AUTOMATICALLY GENERATED FROM /home/admin/.config/libs/zimrc.zsh
# EDIT THE SOURCE FILE AND THEN RUN zimfw build. DO NOT DIRECTLY EDIT THIS FILE!

if [[ -e ${ZIM_CONFIG_FILE:-${ZDOTDIR:-${HOME}}/.zimrc} ]] zimfw() { source "${HOME}/.config/zim/zimfw.zsh" "${@}" }
fpath=("${HOME}/.config/zim/modules/git/functions" "${HOME}/.config/zim/modules/utility/functions" "${HOME}/.config/zim/modules/duration-info/functions" "${HOME}/.config/zim/modules/git-info/functions" "${HOME}/.config/zim/modules/zsh-completions/src" "${HOME}/.config/zim/modules/completion/functions" ${fpath})
